...
{
    public partial class StandartRezervasyon : Form
    {
        public StandartRezervasyon()
        {
            InitializeComponent();
        }
        ...
        private void StandartRezervasyon_Load(object sender, EventArgs e)
        {
            datelbl.Text = DateTime.Now.ToLongTimeString();
            timer1.Start();
        ...
        private void Eklebtn_Click(object sender, EventArgs e)
        {
            ...
            cmd.Parameters.AddWithValue("@p1", "standart");
            cmd.Parameters.AddWithValue("@p2", RezerNotxt.Text);
