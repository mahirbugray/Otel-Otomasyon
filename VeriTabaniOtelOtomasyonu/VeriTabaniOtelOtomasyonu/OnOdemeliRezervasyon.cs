...
{
    public partial class OnOdemeliRezervasyon : Form
    {
        public OnOdemeliRezervasyon()
        {
            InitializeComponent();
        }
        ...
        private void Eklebtn_Click(object sender, EventArgs e)
        {
            ...
            cmd.Parameters.AddWithValue("@p1", "OnOdemeli");
        ...
        private void OnOdemeliRezervasyon_Load(object sender, EventArgs e)
        {
            datelbl.Text = DateTime.Now.ToLongTimeString();
            timer1.Start();
